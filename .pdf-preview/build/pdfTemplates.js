        ...
        <table style="width: 100%; border-collapse: collapse;">
          <thead>
            <tr style="background: linear-gradient(135deg, #475569 0%, #64748b 100%); color: white;">
              ...
              ${showYield ? '<th style="padding: 12px; text-align: center; border-right: 1px solid rgba(255,255,255,0.2);">Доходность</th>' : ''}
              ${showRegularity ? '<th style="padding: 12px; text-align: center;">Регулярность</th>' : ''}
            </tr>
          </thead>
          <tbody>
            ${items
