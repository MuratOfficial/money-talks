...
// попытка сделать навигацию для раздела expense, чтобы передавать данные из addexpense в expense(не сработало)
...
// type ExpenseRouteProp = RouteProp<RootStackParamList, 'Expense'>;
// type ExpenseNavigationProp = NativeStackNavigationProp<RootStackParamList, 'Expense'>;

// type Props = {
//   route: ExpenseRouteProp;
//   navigation: ExpenseNavigationProp;
// };
...
//        <Text style={styles.textBold}>{sum}</Text>
