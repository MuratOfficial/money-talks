...
<Pressable onPress={handlePress} style={styles.pressScreen}>
    <View style={styles.container}>
      <View style={styles.screen}>
        ...
        {/*  */}
        < View>
      <NavBar link2='/finance/screens/analysis/adviceAnalysis' link='/finance' title = 'Анализ' ></NavBar>
        </View>
  
      <View style={styles.container2}>
      <Text style={styles.textBold} >У вас пока нет анализа</Text>
      <Text style={styles.text}>Добавьте ваши расходы, доходы, активы и пассивы,
        и{`\n`}            начните следить за общим анализом</Text>
